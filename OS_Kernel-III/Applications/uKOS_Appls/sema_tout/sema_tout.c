...
;				  Display a string
;
;			- P2: Waiting for the semaphore "Semaphore 0" under timeout
...
LOC_CONST_STRG(aStrApplication[]) =	"sema_tout    Example of how to use semaphores.         (c) EFr-2017";
LOC_CONST_STRG(aStrHelp[])        = "This is a romable C application\n"
									"===============================\n\n"

									"This user function module is a C written application.\n\n"

									"Input format:  sema_tout\n"
...
static	void	aProcess_1(const void *argument) {
	...
	while (TRUE) {
		...
		iotx_printf(KSYST, "uKOS uKernel\n");
	}
}
...
// Get the semaphore handle
	...
	while (TRUE) {
		status = kern_waitSemaphore(semaphore, 1, 1000);
		(status == KKERNTIMEO) ? iotx_printf(KSYST, "Timeout Error\n") : iotx_printf(KSYST, "%6d, (c) 1992-2017, Franzi Edo.\n            "
		                                            										"5-Route de Cheseaux\n            "
