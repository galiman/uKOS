...
#define	KMYNBCOLS	KNBCOLSQVGA			// 320
#define	KMYNBROWS	KNBROWSQVGA			// 240
#endif
...
LOC_CONST_STRG(aStrApplication[]) =	"misc_imgCont Example of how to use an imager.          (c) EFr-2017";
LOC_CONST_STRG(aStrHelp[])        = "This is a romable C application\n"
									"===============================\n\n"

									"This user function module is a C written application.\n\n"

									"Input format:  misc_imgCont\n"
 ...
 * \brief aProcess 1
 *
 * - P2: - Acquire an image and send it
 *
 */
...
// Configurations for an imager APTINA 
	...
	configureIMG0.oDMAEc 	= _transfer;
