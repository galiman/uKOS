...
;
; Project:	uKOS
; Goal:		Set the baud-rate of the uart1 manager.
;
...
LOC_CONST_STRG(aStrApplication[]) =	"uart1        Set the baud-rate of the urt1 manager.    (c) EFr-2017";
LOC_CONST_STRG(aStrHelp[])        = "Set the baud-rate of the urt1 manager\n"
									"=====================================\n\n"

									"This tool sets the baud-rate of the serial\n"
									"manager urt1.\n\n"

									"Input format:  uart1 baud-rate\n"
...
MODULE(Uart1, KIDTOOL, KUART1NUM, prgm, "1.0", ((1<<BSHOW) | (1<<BEXECONSOLE)));
