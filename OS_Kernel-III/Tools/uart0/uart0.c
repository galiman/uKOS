...
;
; Project:	uKOS
; Goal:		Set the baud-rate of the uart0 manager.
;
...
LOC_CONST_STRG(aStrApplication[]) =	"uart0        Set the baud-rate of the urt0 manager.    (c) EFr-2017";
LOC_CONST_STRG(aStrHelp[])        = "Set the baud-rate of the urt0 manager\n"
									"=====================================\n\n"

									"This tool sets the baud-rate of the serial\n"
									"manager urt0.\n\n"

									"Input format:  uart0 baud-rate\n"
...
MODULE(Uart0, KIDTOOL, KUART0NUM, prgm, "1.0", ((1<<BSHOW) | (1<<BEXECONSOLE)));
