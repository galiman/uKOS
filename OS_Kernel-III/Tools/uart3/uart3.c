...
;
; Project:	uKOS
; Goal:		Set the baud-rate of the uart3 manager.
;
...
LOC_CONST_STRG(aStrApplication[]) =	"uart3        Set the baud-rate of the urt3 manager.    (c) EFr-2017";
LOC_CONST_STRG(aStrHelp[])        = "Set the baud-rate of the urt3 manager\n"
									"=====================================\n\n"

									"This tool sets the baud-rate of the serial\n"
									"manager urt3.\n\n"

									"Input format:  uart3 baud-rate\n"
...
MODULE(Uart3, KIDTOOL, KUART3NUM, prgm, "1.0", ((1<<BSHOW) | (1<<BEXECONSOLE)));
