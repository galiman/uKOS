...
#
# Project:	uKOS
# Goal:		makefile for uKOS applications (cortex-m4 specific).
#
...
FLAGS_CC		=  -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -fsingle-precision-constant
...
FLAGS_LD		=  -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb -fsingle-precision-constant
