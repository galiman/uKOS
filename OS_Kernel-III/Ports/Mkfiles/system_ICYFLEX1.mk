...
#
# Project:	uKOS
# Goal:		makefile for uKOS systems (icyflex1 specific).
#
...
PATH_COMPILER	=  $(PATH_GCC_ICYFLEX)

FLAGS_UKOS		=  -D__UKOS__ -D__$(BOARD)__ -D__$(SOC)__ -D__$(CORE)__ -D__BIG_ENDIAN__
SWTCH_OBJDUMP	=  -f -p -g -D -d -h -t -s

FLAGS_CC		=  -Wall -g3 $(ISO_IEC_9899) -fno-strict-aliasing $(OPTIMISATION)
FLAGS_CC		+= $(STANDARD)
...
FLAGS_LD		= -nostartfiles -Wl,-T$(LINKS_LD),-Map,$(TARGET).map
...
utils :
	...
	$(BIN2CKSUM) -icyflex1 $(TARGET).bin $(TARGET).ck
	$(BIN2XML) -erase -icycamheader 0x00000000 -E8192K $(TARGET).bin $(TARGET).xml
