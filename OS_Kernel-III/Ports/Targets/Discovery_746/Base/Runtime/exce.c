...
;
; Project:	uKOS
; Goal:		Exceptions for the Baphomet_746 module.
;
...
void	_setLEDs(uint8_t ledNb) {
	...
	switch (ledNb) {
		case 0: { GPIOA->ODR |= (1<<BLED0); break; }
		case 1: { GPIOA->ODR |= (1<<BLED1); break; }
		case 2: { GPIOH->ODR |= (1<<BLED2); break; }
		case 3: { GPIOH->ODR |= (1<<BLED3); break; }
		case 4: { GPIOD->ODR |= (1<<BLED4); break; }
		case 5: { GPIOD->ODR |= (1<<BLED5); break; }
		case 6: { GPIOG->ODR |= (1<<BLED6); break; }
		case 7: { GPIOD->ODR |= (1<<BLED7); break; }
		default: {
			break;
		}
	}
