...
;------------------------------------------------------------------------
				...
				.global		_handle_usb0_interruptionRX
				.extern		_stub_usb0_interruptionRX
				.extern		_saveScratchRegisters
				.extern		_restoreScratchRegisters

				.section	.text

; Interruption usb0 RX
; --------------------

_handle_usb0_interruptionRX:
				jsr			_saveScratchRegisters			; Save the scratch registers
				nop											;
				sjsr		_stub_usb0_interruptionRX		; Process the usb0 interruption
				nop											;
