...
#define	KDEFAULT_BAUDRATE	115200

// System version check
// --------------------

#define	__CHECK_OS_VERSION__	// Without the check of the OS version
								// Special case for all RAM systems (icyflex1)
								// Only 32-K are tested
...
#define	__MAN_VIS0__			// With the VIS0 manager
