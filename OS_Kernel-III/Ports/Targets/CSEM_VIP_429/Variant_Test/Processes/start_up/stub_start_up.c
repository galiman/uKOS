...
#define	__CONSOLE__							// defined = console, undefined = viewer + console
...
#else
static	const	char_t	*argv_cnsUrt0[] = { "console", "urt0" };
static	const	char_t	*argv_viwUrt0[] = { "viewer" };

static	const	boot_t	aFunction[] = {
							{ 0x00, "viewer",  KBD460800, KURT0, 1, argv_viwUrt0 },
							{ 0x00, "console", KBD460800, KURT0, 2, argv_cnsUrt0 }
						};
#endif
