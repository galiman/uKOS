...
#define	KNBCHANNEL	3
#define	KVALCCR		(ADC_CCR_TSVREFE | ADC_CCR_VBATE | ADC_CCR_ADCPRE_1 | ADC_CCR_ADCPRE_0)
#define	KVALCR1		0
...
static	const		uint32_t	aChannel[KNBCHANNEL] = { 16, 17, 18 };	// The analog input channels to convert
