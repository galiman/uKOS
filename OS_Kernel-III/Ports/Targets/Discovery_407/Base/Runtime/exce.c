...
;
; Project:	uKOS
; Goal:		Exceptions for the Discovery_407 module.
;
...
void	_setLEDs(uint8_t ledNb) {
	...
	switch (ledNb) {
		case 0: { GPIOC->ODR |= (1<<BLED0); break; }
		case 1: { GPIOC->ODR |= (1<<BLED1); break; }
		case 2: { GPIOE->ODR |= (1<<BLED2); break; }
		case 3: { GPIOC->ODR |= (1<<BLED3); break; }
		case 4: { GPIOD->ODR |= (1<<BLED4); break; }
		case 5: { GPIOD->ODR |= (1<<BLED5); break; }
		case 6: { GPIOD->ODR |= (1<<BLED6); break; }
