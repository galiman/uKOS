...
#define	__WITHMBOX__				// With mail box functions
...
#define	__WITHSIGN__				// With signal functions
#define	__WITHSTAT__				// With statistic functions
#define	__WITHDEBG__				// With debug functions
#define	__WITHSTIM__				// With software timer functions
#define	__WITHPOOL__				// With memory pool functions
...
#define	KNBPROCESS		32			// Number of process
...
#define	KNBASTP			16			// Number of string to pointer associations
#define	KNBMBOX			16			// Number of mailboxes
#define	KNBPACKS		16			// Number of packets in a mailbox
#define	KNBSEMAPHO		32			// Number of semaphores
...
#define	KSZSTACKMIN		400			// Minimal stack size of the process (32.bits)
#define	KSZSTACKNLB		(400+600)	// Newlib stack size of the process (32.bits)
#define	KSZSTACKSQE		(400+1000)	// SQE stack size of the process (32.bits)
#define	KSZSTACKMPY		(400+1000)	// MPY stack size of the process (32.bits)
