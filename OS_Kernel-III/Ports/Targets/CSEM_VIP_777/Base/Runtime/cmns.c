...
#define	KVBD1000000_2		(KFREQUENCY_APB1/1000000)
#define	KVBD1000000_1		(KFREQUENCY_APB2/1000000)
...
void	cmns_init(void) {
    ...
    USART1->BRR	 =BAUDRATE(KFREQUENCY_APB2, KDEFAULT_BAUDRATE); 
