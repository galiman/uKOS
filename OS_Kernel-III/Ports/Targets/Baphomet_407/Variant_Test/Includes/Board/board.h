...
#define	KBOARD			"Baphomet 407 (Variant_Test)"
#define	KTARGET			"Baphomet_407"
...
#define	BSELADT7320		4										// PORT A 4, /CS of the device
#define	BOI0			7										// PORT A 7, OI0 extension bus
#define	BIO3			8										// PORT A 8, IO3 extension bus

#define	BSW1			1										// PORT B 1, SW1
#define	BSELEEPROM		12										// PORT B 12, /CS of the EEPROM

#define	BCTS			0										// PORT C 0, CTS from the PAN1322
#define	BOI5			1										// PORT C 1, OI5 extension bus
...
#define	BLED0			6										// PORT F 6, LED
#define	BSW3			7										// PORT F 7, SW3
#define	BLED1			8										// PORT F 8, LED
#define	BSW2			10										// PORT F 10, SW2

#define	BIO2			6										// PORT G 6, IO2 extension bus
#define	BTP3			7										// PORT G 7, test point 3
#define	BTP4			8										// PORT G 8, test point 3
#define	BLED2			11										// PORT G 11, LED
#define	BLED3			12										// PORT G 12, LED
#define	BNOSDCARD		14										// PORT G 14, SDCard inside the slot 
#define	BLED4			15										// PORT G 15, LED

#define	BLED5			2										// PORT H 2, LED
#define	BLED6			3										// PORT H 3, LED
#define	BOI6			6										// PORT H 6, OI5 extension bus
#define	BOI7			7										// PORT H 7, OI5 extension bus

#define	BLED7			8										// PORT I 8, LED
