...
static	const	char_t	*argv_cnsUrt2[] = { "console", "urt2" };
static	const	char_t	*argv_cnsUrt3[] = { "console", "urt3" };
static	const	char_t	*argv_cnsUrt4[] = { "console", "blt0" };
static	const	char_t	*argv_cnsUsb0[] = { "console", "usb0" };
...
static	const	boot_t	aFunction[] = {
							...
							{ 0x02, "console", KBD460800, KURT1, 2, argv_cnsUrt1 },
							{ 0x03, "sloader", KBD460800, KURT1, 2, argv_sloader },
							{ 0x04, "console", KBD460800, KURT2, 2, argv_cnsUrt2 },
							{ 0x05, "sloader", KBD460800, KURT2, 2, argv_sloader },
							{ 0x06, "console", KBD460800, KURT3, 2, argv_cnsUrt3 },
							{ 0x07, "console", KBD460800, KUSB0, 2, argv_cnsUsb0 },
							{ 0x08, "console", KBD460800, KURT4, 2, argv_cnsUrt4 },
							{ 0x09, "userapp", KBD460800, KURT0, 2, argv_userApp }
						};
...
GLB_CONST_STRG(aStrHelp[]) =	"Start-up process\n"
								...
								"    4   KURT2, console (460800-bit/s).\n"
								"    5   KURT2, sloader (460800-bit/s).\n"
								"    6   KURT3, console (460800-bit/s).\n"
								"    7   KUSB1, console (460800-bit/s).\n"
								"    8   KURT4, console (460800-bit/s).\n"
								"    9   KURT0, userapp (460800-bit/s).\n\n";
...
// The last available function in the table is considered for the default communication manager
			...
			switch (aFunction[i].oCommManager) {
				...
				case KURT1: { configureURTx.oBaudRate = aFunction[i].oBaudrate; urt1_configure(&configureURTx); break; }
				case KURT2: { configureURTx.oBaudRate = aFunction[i].oBaudrate; urt2_configure(&configureURTx); break; }
				case KURT3: { configureURTx.oBaudRate = aFunction[i].oBaudrate; urt3_configure(&configureURTx); break; }
				case KURT4: { configureURTx.oBaudRate = aFunction[i].oBaudrate; urt4_configure(&configureURTx); break; }
				default: {
					break;
				}
			}
