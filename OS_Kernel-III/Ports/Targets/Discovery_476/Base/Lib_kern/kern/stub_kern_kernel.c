...
#define	KFREQUENCY_T1				KFREQUENCY_APB2
#define	KFREQUENCY_T2				KFREQUENCY_APB1
#define	KFREQUENCY_T3				KFREQUENCY_APB1
#define	KFREQUENCY_T4				KFREQUENCY_APB1
...
#include 	<model_kernel_tim_1_2_3_4_ex2_ex3.cm>
