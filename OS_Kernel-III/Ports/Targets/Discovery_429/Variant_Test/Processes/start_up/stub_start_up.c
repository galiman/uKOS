...
static	const	boot_t	aFunction[] = {
							...
							{ 0x03, "userapp", KBD460800, KURT0, 2, argv_userApp }
						};
 ...
 *
 */
void	stub_start_up_launch(const void *argument) {
			uint8_t		i;
			uint16_t	index;
			uint32_t	mode;
