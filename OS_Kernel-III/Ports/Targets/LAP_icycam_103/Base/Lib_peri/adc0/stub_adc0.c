...
#define	KNBCHANNEL	3
#define	KVALCR2		((0xE<<16) | ADC_CR2_TSVREFE | ADC_CR2_CONT | ADC_CR2_ADON)

#define KTSAMPLEADC	(0.001)												// For 1-mS
#define	KFPRET4		10000												// 10'000-Hz
#define	KFINTT4		(1/KTSAMPLEADC)										// 1-Hz
#define KPSCT4		((KFREQUENCY_AHB/KFPRET4)-1)						// Prescaler for 10'000-Hz
#define KARRT4		((KFPRET4/KFINTT4)-1)								// Autoreload

#define	KVREF		(3.3)												// Reference of 3.3-V
...
static	const		uint32_t	aChannel[KNBCHANNEL] = { 16, 17, 1 };	// The analog input channels to convert
