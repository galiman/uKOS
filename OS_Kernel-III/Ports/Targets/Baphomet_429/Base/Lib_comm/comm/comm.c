...
int32_t	comm_reserve(uint32_t commManager, uint8_t mode) {
	...
	switch (manager) {
		...
		case KURT1: { return (urt1_reserve(mode)); }
		case KURT2: { return (urt2_reserve(mode)); }
		case KURT3: { return (urt3_reserve(mode)); }
		case KURT4: { return (urt4_reserve(mode)); }
		case KUSB0: { return (usb0_reserve(mode)); }
...
int32_t	comm_release(uint32_t commManager, uint8_t mode) {
	...
	switch (manager) {
		...
		case KURT1: { return (urt1_release(mode)); }
		case KURT2: { return (urt2_release(mode)); }
		case KURT3: { return (urt3_release(mode)); }
		case KURT4: { return (urt4_release(mode)); }
		case KUSB0: { return (usb0_release(mode)); }
		default:    { return (KCOMMNODEV); 		   }
	}
}
...
int32_t	comm_configure(uint32_t commManager, const void *configure) {
	...
	switch (manager) {
		...
		case KURT1: { return (urt1_configure((const cnfUrtx_t *)configure)); }
		case KURT2: { return (urt2_configure((const cnfUrtx_t *)configure)); }
		case KURT3: { return (urt3_configure((const cnfUrtx_t *)configure)); }
		case KURT4: { return (urt4_configure((const cnfUrtx_t *)configure)); }
		case KUSB0: { return (usb0_configure((const cnfUsbx_t *)configure)); }
		default:    { return (KCOMMNODEV); 							         }
	}
}
...
int32_t	comm_write(uint32_t commManager, const uint8_t *buffer, uint32_t size) {
	...
	switch (manager) {
		...
		case KUSB0: { return (usb0_write(buffer, size)); }
		default:    { return (KCOMMNODEV); 				 }
	}
}
...
int32_t	comm_read(uint32_t commManager, uint8_t *buffer, uint32_t *size) {
	...
	switch (manager) {
		...
		case KUSB0: { return (usb0_read(buffer, size)); }
		default:    { return (KCOMMNODEV); 				}
	}
}
...
int32_t	comm_getIdSemaphore(uint32_t commManager, uint8_t semaphore, char_t **identifier) {
	...
	switch (manager) {
		...
		case KUSB0: { return (usb0_getIdSemaphore(semaphore, identifier)); }
		default:    { return (KCOMMNODEV); 								   }
	}
}
