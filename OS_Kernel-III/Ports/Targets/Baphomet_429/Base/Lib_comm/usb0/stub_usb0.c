...
static	volatile	uint8_t		vTemp_1;
static	volatile	uint8_t		vTemp_2;
static	volatile	uint8_t		vTemp_3 __attribute__ ((unused));
 ...
 *
 */
static	void	workAroundFMC(void) {

	INTERRUPTION_OFF;
	*LOCFTDI = vTemp_1;
		
// Waiting for T7 + T11 + T12 = 50 + 25 + 80 = 155ns
