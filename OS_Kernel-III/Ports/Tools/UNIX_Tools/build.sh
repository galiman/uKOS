...
#	Projects & actions
	...
	"bin2s"			"clean_all"		"all"	"clean_all"
	"bin2xml"		"clean_all"		"all"	"clean_all"
	"bin2cksum"		"clean_all"		"all"	"clean_all"
	"uKOSlog"		"clean_all"		"all"	"clean_all"
	"dump"			"clean_all"		"all"	"clean_all"
	"filer"			"clean_all"		"all"	"clean_all"
	"S2Table"		"clean_all"		"all"	"clean_all"
	)
