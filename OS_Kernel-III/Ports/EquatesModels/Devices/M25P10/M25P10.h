...
#define	KNBPAGE					512										// Number of pages
#define	KSZPAGE					256										// Page size
#define	KNBSECTOR				4										// Number of sectors
#define	KSZSECTOR				32768									// Sector size
#define	KSZEEPROM				(KNBSECTOR*KSZSECTOR)					// EEPROM size

// Commands for the chip M25P10
...
// Status bits for the chip M25P10
