...
#ifndef __ICYAMR_TIMER__
#define __ICYAMR_TIMER__

// TIMER address definitions
// -------------------------

#define	TIMER0_CTRL					(volatile uint16_t  *)(TIMER0 + 0x00)
#define	TIMER1_CTRL					(volatile uint16_t  *)(TIMER1 + 0x00)
#define	TIMER2_CTRL					(volatile uint16_t  *)(TIMER2 + 0x00)
#define	TIMER3_CTRL					(volatile uint16_t  *)(TIMER3 + 0x00)
#define	BTIMER_EN					0
...
#define	TIMER0_STATUS				(volatile uint8_t  *)(TIMER0 + 0x02)
#define	TIMER1_STATUS				(volatile uint8_t  *)(TIMER1 + 0x02)
#define	TIMER2_STATUS				(volatile uint8_t  *)(TIMER2 + 0x02)
#define	TIMER3_STATUS				(volatile uint8_t  *)(TIMER3 + 0x02)
#define	TIMER0_IRQEN				(volatile uint8_t  *)(TIMER0 + 0x03)
#define	TIMER1_IRQEN				(volatile uint8_t  *)(TIMER1 + 0x03)
#define	TIMER2_IRQEN				(volatile uint8_t  *)(TIMER2 + 0x03)
#define	TIMER3_IRQEN				(volatile uint8_t  *)(TIMER3 + 0x03)
