...
// STM32 specific Interrupt Numbers
	...
	UART7_IRQHandler,							// Address: 0x0000_0188
	UART8_IRQHandler,							// Address: 0x0000_018C
	SPI4_IRQHandler,							// Address: 0x0000_0190
	SPI5_IRQHandler,							// Address: 0x0000_0194
	SPI6_IRQHandler,							// Address: 0x0000_0198
	SAI1_IRQHandler,							// Address: 0x0000_019C
	LTDC_IRQHandler,							// Address: 0x0000_01A0
	LTDC_ER_IRQHandler,							// Address: 0x0000_01A4
	DMA2D_IRQHandler,							// Address: 0x0000_01A8
	SAI2_IRQHandler,							// Address: 0x0000_01AC
	QUADSPI_IRQHandler,							// Address: 0x0000_01B0
	LPTIM1_IRQHandler,							// Address: 0x0000_01B4
	CEC_IRQHandler,								// Address: 0x0000_01B8
	I2C4_EV_IRQHandler,							// Address: 0x0000_01BC
	I2C4_ER_IRQHandler,							// Address: 0x0000_01C0
	SPDIF_RX_IRQHandler,						// Address: 0x0000_01C4
	0,											// Reserved
	DFSDM1_FLT0_IRQHandler,						// Address: 0x0000_01CC
	DFSDM1_FLT1_IRQHandler,						// Address: 0x0000_01D0
	DFSDM1_FLT2_IRQHandler,						// Address: 0x0000_01D4
	DFSDM1_FLT3_IRQHandler,						// Address: 0x0000_01D8
	SDMMC2_IRQHandler,							// Address: 0x0000_01DC
	CAN3_TX_IRQHandler,							// Address: 0x0000_01E0
	CAN3_RX0_IRQHandler,						// Address: 0x0000_01E4
	CAN3_RX1_IRQHandler,						// Address: 0x0000_01E8
	CAN3_SCE_IRQHandler,						// Address: 0x0000_01EC
	JPEG_IRQHandler,							// Address: 0x0000_01F0
	MDIOS_IRQHandler							// Address: 0x0000_01F4
};
...
void	UART7_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[UART7_IRQn];
	(*go)(UART7_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	UART8_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[UART8_IRQn];
	(*go)(UART8_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	SPI4_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[SPI4_IRQn];
	(*go)(SPI4_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	SPI5_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[SPI5_IRQn];
	(*go)(SPI5_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	SPI6_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[SPI6_IRQn];
	(*go)(SPI6_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	LTDC_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[LTDC_IRQn];
	(*go)(LTDC_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	LTDC_ER_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[LTDC_ER_IRQn];
	(*go)(LTDC_ER_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	DMA2D_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[DMA2D_IRQn];
	(*go)(DMA2D_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	CEC_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[CEC_IRQn];
	(*go)(CEC_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	I2C4_EV_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[I2C4_EV_IRQn];
	(*go)(I2C4_EV_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	I2C4_ER_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[I2C4_ER_IRQn];
	(*go)(I2C4_ER_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	SPDIF_RX_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[SPDIF_RX_IRQn];
	(*go)(SPDIF_RX_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	SDMMC2_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[SDMMC2_IRQn];
	(*go)(SDMMC2_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	CAN3_TX_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[CAN3_TX_IRQn];
	(*go)(CAN3_TX_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	CAN3_RX0_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[CAN3_RX0_IRQn];
	(*go)(CAN3_RX0_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	CAN3_RX1_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[CAN3_RX1_IRQn];
	(*go)(CAN3_RX1_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	CAN3_SCE_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[CAN3_SCE_IRQn];
	(*go)(CAN3_SCE_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	JPEG_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[JPEG_IRQn];
	(*go)(JPEG_IRQn);
	TAC_EXCEPTION_TIME;
}
...
void	MDIOS_IRQHandler(void) {
	...
	TIC_EXCEPTION_TIME;
	go = (void (*)(uint8_t exceptionNb))vExce_indIntVectors[MDIOS_IRQn];
	(*go)(MDIOS_IRQn);
	TAC_EXCEPTION_TIME;
}
